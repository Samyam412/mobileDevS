...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 7990890653225163334),
      name: 'Batch',
      lastPropertyId: const IdUid(3, 6401688288201065415),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 9149737680838611340),
            name: 'id',
            type: 6,
            flags: 129),
        ModelProperty(
            id: const IdUid(2, 2349034939149875673),
            name: 'batchId',
            type: 9,
            flags: 2080,
            indexId: const IdUid(1, 5099866609593089797)),
        ModelProperty(
            id: const IdUid(3, 6401688288201065415),
            name: 'batchName',
            type: 9,
            flags: 0)
      ],
  ...
  ModelEntity(
      id: const IdUid(2, 4011635541537723401),
      name: 'Course',
      lastPropertyId: const IdUid(3, 837101741819325884),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 8614210995010773422),
            name: 'id',
            type: 6,
            flags: 129),
        ModelProperty(
            id: const IdUid(2, 7062588780279299201),
            name: 'courseId',
            type: 9,
            flags: 2080,
            indexId: const IdUid(2, 5365885476471892057)),
        ModelProperty(
            id: const IdUid(3, 837101741819325884),
            name: 'courseName',
            type: 9,
            flags: 0)
      ],
  ...
  ModelEntity(
      id: const IdUid(3, 3682719873851489528),
      name: 'Student',
      lastPropertyId: const IdUid(6, 4887278891845817226),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 6623200238558633212),
            name: 'stdId',
            type: 6,
            flags: 129),
        ModelProperty(
            id: const IdUid(2, 2671958651587064101),
            name: 'fname',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 4399703812794800369),
            name: 'lname',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 6893189439769084783),
            name: 'username',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(5, 7124987918403295540),
            name: 'password',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(6, 4887278891845817226),
            name: 'batchId',
            type: 11,
            flags: 520,
            indexId: const IdUid(3, 5555325175245480986),
            relationTarget: 'Batch')
      ],
      relations: <ModelRelation>[
        ModelRelation(
            id: const IdUid(1, 5632833261564026746),
            name: 'course',
            targetId: const IdUid(2, 4011635541537723401))
      ],
      backlinks: <ModelBacklink>[])
];
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(3, 3682719873851489528),
      lastIndexId: const IdUid(3, 5555325175245480986),
      lastRelationId: const IdUid(1, 5632833261564026746),
